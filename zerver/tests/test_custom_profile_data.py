...
class CreateCustomProfileFieldTest(CustomProfileFieldTestCase):
    ...
    def test_create_select_multiple_field(self) -> None:
        self.login("iago")
        data: dict[str, str | int] = {}
        data["name"] = "Favorite tools"
        data["field_type"] = CustomProfileField.SELECT_MULTIPLE
        data["field_data"] = orjson.dumps(
            {
...
class UpdateCustomProfileFieldTest(CustomProfileFieldTestCase):
    ...
    def test_update_select_multiple_field_successfully(self) -> None:
        self.login("iago")
        realm = get_realm("zulip")
