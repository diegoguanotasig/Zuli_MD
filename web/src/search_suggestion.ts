...
const channels_archived_incompatible_patterns: TermPattern[] = [
    ...common_incompatible_patterns,
...
const incompatible_patterns: Record<SearchFilter, TermPattern[]> = {
    ...
    "channels:archived": channels_archived_incompatible_patterns,
    topic: [
        {operator: "dm"},
        {operator: "is", operand: "dm"},
        {operator: "dm-including"},
...
function get_channels_filter_suggestions(
    ...
    const suggestions: Suggestion[] = [
        ...filter_suggestions_by_criteria(terms, [archived_channels_search_string]),
    ];
